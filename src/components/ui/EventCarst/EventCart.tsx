...
export default function MatchCard({ event }: MatchCardProps) {
  ...
  return (
    <div className="bg-shadow-inset-primary backdrop-blur-xs rounded-3xl p-[20px] md:p-10 border border-purple-500/40 max-w-[595px] mx-auto">
        ...
        <div className="text-center">
          {event.logoA && (
            <img
              ...
              className="w-32 h-32 md:w-[140px] md:h-[140px] object-contain mx-auto mb-4 rounded-full border-4 border-blue-600/50 shadow-lg"
            />
          )}
          <p className="text-xl md:text-2xl font-semibold text-shadow-primary">{event.participantA}</p>
        </div>

        <div className="text-5xl md:text-7xl font-black bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent">VS</div>
        ...
        <div className="text-center">
          {event.logoB && (
            <img
              ...
              className="w-32 h-32 md:w-[140px] md:h-[140px] object-contain mx-auto mb-4 rounded-full border-4 border-red-600/50 shadow-lg"
            />
          )}
